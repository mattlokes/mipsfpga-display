...
//
//    Description :  MIPSfpga Display support library font header
//
//
/////////////////////////////////////////////////
...
#ifndef MFDLIB_FONT_H_
#define MFDLIB_FONT_H_

   #define MFD_FONT_W 6
   #define MFD_FONT_H 8

   const unsigned char mfd_font[96][5] = {
