...
#
# Generated by export_simulation on Mon Apr 25 19:47:58 +0100 2016
#
################################################################################
...
switch to the './tb_hw_clk_wiz.sh' script.

./tb_hw_clk_wiz.sh -reset_run
...
./tb_hw_clk_wiz.sh -noclean_files

For more information on the script, please type './tb_hw_clk_wiz.sh -help'.
