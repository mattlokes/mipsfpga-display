...
#
# Generated by export_simulation on Mon Apr 25 19:47:08 +0100 2016
#
################################################################################
...
switch to the './pal_bram_mem_gen.sh' script.

./pal_bram_mem_gen.sh -reset_run
...
./pal_bram_mem_gen.sh -noclean_files

For more information on the script, please type './pal_bram_mem_gen.sh -help'.
