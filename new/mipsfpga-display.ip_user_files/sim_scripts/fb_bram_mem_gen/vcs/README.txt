...
#
# Generated by export_simulation on Mon Apr 25 19:47:20 +0100 2016
#
################################################################################
...
switch to the './fb_bram_mem_gen.sh' script.

./fb_bram_mem_gen.sh -reset_run
...
./fb_bram_mem_gen.sh -noclean_files

For more information on the script, please type './fb_bram_mem_gen.sh -help'.
