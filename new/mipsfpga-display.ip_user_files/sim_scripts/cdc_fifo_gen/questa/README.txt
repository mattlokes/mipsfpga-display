...
#
# Generated by export_simulation on Mon Apr 25 15:41:04 +0100 2016
#
################################################################################
...
switch to the './cdc_fifo_gen.sh' script.

./cdc_fifo_gen.sh -reset_run
...
./cdc_fifo_gen.sh -noclean_files

For more information on the script, please type './cdc_fifo_gen.sh -help'.
